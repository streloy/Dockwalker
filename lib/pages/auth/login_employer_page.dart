import 'package:dockwalker/controllers/auth/login_employer_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class LoginEmployerPage extends StatefulWidget {
  const LoginEmployerPage({super.key});

  @override
  State<LoginEmployerPage> createState() => _LoginEmployerPageState();
}

class _LoginEmployerPageState extends State<LoginEmployerPage> {

  final LoginEmployerController _controller = Get.put(LoginEmployerController());
    ...
    return Theme(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Employer Login', style: TextStyle(fontWeight: FontWeight.bold) ),
          titleSpacing: 0,
          actions: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text( "Forget your password?", style: TextStyle( color: Colors.white, fontSize: 14 ) ),
                              InkWell(onTap: () { _controller.gotoResetPassword(); }, child: Text( "Reset Password", style: TextStyle( color: Colors.white, fontSize: 14, fontWeight: FontWeight.bold ) )),
                            ],
                          ),
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text( "Don't have account?", style: TextStyle( color: Colors.white, fontSize: 14 ) ),
                              InkWell( onTap: () { _controller.gotoEmployerRegistration(); }, child: Text( "Create an account", style: TextStyle( color: Colors.white, fontSize: 14, fontWeight: FontWeight.bold ) )),
                            ],
                          ),
                        ],
                      ),
